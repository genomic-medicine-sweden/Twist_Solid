...
The following reference files, panel of nornmals and design files are need to run the Twist Solid Pipeline:
...
**Result files**
Files needed by Twist Solid that are generated by the pipeline itself are listed below:
