...
module alignment:
    snakefile:
        github("hydra-genetics/alignment", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module snv_indels:
    snakefile:
        github("hydra-genetics/snv_indels", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module annotation:
    snakefile:
        github("hydra-genetics/annotation", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module filtering:
    snakefile:
        github("hydra-genetics/filtering", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module biomarker:
    snakefile:
        github("hydra-genetics/biomarker", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module fusions:
    snakefile:
        github("hydra-genetics/fusions", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module cnv_sv:
    snakefile:
        github("hydra-genetics/cnv_sv", path="workflow/Snakefile", tag="develop")
    config:
        config
...
module misc:
    snakefile:
        github("hydra-genetics/misc", path="workflow/Snakefile", tag="develop")
    config:
        config
