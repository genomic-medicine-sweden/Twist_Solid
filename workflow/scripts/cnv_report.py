...
if __name__ == "__main__":
    ...
    in_del = snakemake.input.del
    in_amp = snakemake.input.amp
    ...
    create_tsv_report(in_vcfs, in_org_vcfs, in_del, in_amp, out_tsv, del_1p19q_cn, del_1p19q_chr_arm_fraction, TC)
