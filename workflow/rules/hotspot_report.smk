...
rule hotspot_report:
    input:
        ...
        vcf="annotation/add_multi_snv_in_codon/{sample}_{type}.background_annotation.filter.snv_hard_filter.codon_snvs.sorted.vep_annotated.vcf.gz",
        vcf_index="annotation/add_multi_snv_in_codon/{sample}_{type}.background_annotation.filter.snv_hard_filter.codon_snvs.sorted.vep_annotated.vcf.gz.tbi",
