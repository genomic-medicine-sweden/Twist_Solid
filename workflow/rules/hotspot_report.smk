...
rule hotspot_report:
    input:
        ...
        vcf_wo_pick="snv_indels/bcbio_variation_recall_ensemble/{sample}_{type}.ensembled.vep_annotated_wo_pick.vcf.gz",
        vcf_wo_pick_index="snv_indels/bcbio_variation_recall_ensemble/{sample}_{type}.ensembled.vep_annotated_wo_pick.vcf.gz.tbi",
